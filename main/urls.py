...
urlpatterns = [
    ...
    path('accounts/profie/change/<int:pk>/', PostChange.as_view(), name='profile_post_change'),
    path('accounts/profile/delete/<int:pk>/', PostDelete.as_view(), name='profile_post_delete'),
    ...
    path('tags/<str:slug>/', TagDetail.as_view(), name='tag_detail'),
